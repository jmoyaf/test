...
server2 = sys.argv[5]
server3 = sys.argv[6]
order_possible_servers = [server1,server2,server3]
...
print history[1][0]
print history[1][1]
print list_possible_servers
print list_ip_possible_servers
print number_servers_ok
print number_servers_get_up
print order_possible_servers
