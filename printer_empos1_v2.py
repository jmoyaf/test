...
# Get raw data
def rawData():
  url = urllib.urlopen("http://root:aaaaaa@192.168.100.218/printer/infotosave.htm")
  raw = url.read()
  url.close()
  return raw
...
def writeData(x,y,z):
  colorfile = open('/home/jesus/Scripts/Python/empos/colorfile' + x + '.218', 'w')
  monofile = open('/home/jesus/Scripts/Python/empos/monofile' + x + '.218', 'w')
  colorfile.write(y)
  monofile.write(z)
  colorfile.close()
  monofile.close()
...
#Get copies
def getCopies(x,y):
  firstfilecolor = open('/home/jesus/Scripts/Python/empos/colorfile' + y + '.218', 'r')
  firstfilemono = open('/home/jesus/Scripts/Python/empos/monofile' + y + '.218', 'r')
  todayfilecolor = open('/home/jesus/Scripts/Python/empos/colorfile' + x + '.218', 'r')
  todayfilemono = open('/home/jesus/Scripts/Python/empos/monofile' + x + '.218', 'r')
...
def sendMail(x,y,z):
  msg = MIMEMultipart()
  msg['From'] = 'impresora_empos1@seres.es'
  msg['To'] = 'us-sistemas2@seres.es'
  msg['Cc'] = 'us-sistemas2@seres.es'
  msg['Subject'] = z + 'copias empos1 ' + y
  ...
  mailserver.ehlo()
  mailserver.sendmail('impresora_empos1@seres.es',('us-sistemas2@seres.es','us-sistemas2@seres.es'),msg.as_string())
  mailserver.quit()
